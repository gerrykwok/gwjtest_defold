...
#include <jni.h>
/* Header for class com_xishanju_plm_plmext_LuaJavaBridge */

#ifndef _Included_com_xishanju_plm_plmext_LuaJavaBridge
#define _Included_com_xishanju_plm_plmext_LuaJavaBridge
#ifdef __cplusplus
extern "C" {
#endif
/*
