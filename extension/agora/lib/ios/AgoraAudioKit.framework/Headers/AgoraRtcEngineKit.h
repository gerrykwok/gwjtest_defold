...
@protocol AgoraRtcEngineDelegate <NSObject, AgoraBaseDelegate>
@optional
 ...
 */
- (void)rtcEngine:(AgoraRtcEngineKit * _Nonnull)engine didJoinChannel:(NSString * _Nonnull)channelId withUid:(NSUInteger)uid elapsed:(NSInteger) elapsed;
 ...
 *  @param elapsed The elapsed time (ms) from session beginning
 */
- (void)rtcEngine:(AgoraRtcEngineKit * _Nonnull)engine didRejoinChannel:(NSString * _Nonnull)channelId withUid:(NSUInteger)uid elapsed:(NSInteger) elapsed;
...
@property (nonatomic, weak) id<AgoraRtcEngineDelegate2> _Nullable delegate2;
...
+ (instancetype _Nonnull)sharedEngineWithAppId:(NSString * _Nonnull)appId
                                      delegate2:(id<AgoraRtcEngineDelegate2> _Nullable)delegate;
...
- (void)setRemoteVideoRenderer2:(id<AgoraVideoSinkProtocol> _Nullable)videoRenderer forUserId:(NSString * _Nonnull)userId;
- (id<AgoraVideoSinkProtocol> _Nullable)remoteVideoRendererOfUserId2:(NSString * _Nonnull)userId;
