...
class Config:
    ...
    def get_cindex_library(self):
        try:
           #gwj library = cdll.LoadLibrary(self.get_filename())
           py_dir = os.path.dirname(__file__) #gwj
           library = cdll.LoadLibrary(py_dir + "/../libclang/" + self.get_filename()) #gwj
        except OSError as e:
